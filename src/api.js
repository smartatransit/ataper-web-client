...
const fetchScheduleByStationAndDay = (station, day) => async () => {
    ...
    const response = await fetch(`https://staging.api.ataper.com/api/static/schedule/station?schedule=${day}&station-name=${station}`);
...
const fetchArrivalsByLineAndStation = (line, station) => async () => {
    ...
    const response = await fetch(`https://staging.api.ataper.com/api/live/schedule/line?line=${line}`);
...
const fetchlines = async () => {
    const response = await fetch(`https://staging.api.ataper.com/api/static/lines`);
    const jsonData = response.json();
...
const fetchDirections = async () => {
    ...
    const response = await fetch(`https://staging.api.ataper.com/api/static/directions`);
    const jsonData = response.json();
...
const fetchStationsByLineAndDirection = (line, direction) => async () => {
    ...
    const response = await fetch(`https://staging.api.ataper.com/api/static/stations?line=${line}&direction=${direction}&schedule=${schedule}`);
    const jsonData = response.json();
...
const fetchStationsByLocation = () => async () => {
    ...
    const response = await fetch(`https://staging.api.ataper.com/api/static/stations/location?latitude=${position.latitude}&longitude=${position.longitude}`);
    const jsonData = response.json();
...
const fetchArrivalsByStationAndDirection = (station, direction) => async () => {
    ...
    for(const line of lines) {
        const response = fetch(`https://staging.api.ataper.com/api/live/schedule/line/${capitalizeFirstLetter(line)}`);
